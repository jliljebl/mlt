...
extern mlt_consumer consumer_sdl2_widget_init( mlt_profile profile, mlt_service_type type, const char *id, char *arg );
...
MLT_REPOSITORY
{
	...
	MLT_REGISTER( consumer_type, "sdl2_widget", consumer_sdl2_widget_init );
	MLT_REGISTER_METADATA( consumer_type, "sdl2_widget", metadata, "consumer_sdl2_widget.yml" );
